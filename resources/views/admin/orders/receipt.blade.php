...
$loyaltyClaimsApplied = (int) data_get($order->meta, 'loyalty.claims_applied', 0);
        ...
        {{-- Download / Print + Send buttons BELOW the receipt --}}
        <div class="actions-bottom no-print">
            <button type="button" class="btn btn-download" onclick="window.print()">
                Download / Print Receipt
            </button>

            <button type="button" class="btn btn-send" id="btnSendReceipt">
                Save & send to Customer Email
            </button>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const btnSend = document.getElementById('btnSendReceipt');
            if (!btnSend) return;
            ...
            btnSend.addEventListener('click', function() {
                ...
                fetch("{{ route('admin.orders.receipt.send', $order) }}", {
                        method: 'POST',
                        headers: {
                    ...
                    .then(async (res) => {
                        ...
                        // Success – show a simple success message
                    ...
                    .catch((err) => {
                        ...
                        // Fail silently (no alert) or you can log only
                    })
                    .finally(() => {
