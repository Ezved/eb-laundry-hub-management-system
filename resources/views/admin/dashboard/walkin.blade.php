        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.walkin.preview') }}" method="POST">
                    ...
                    <div class="grid">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="customer_name"
                                value="{{ old('customer_name', data_get($prefill, 'customer_name')) }}" required>
                        </div>

                        <div class="field">
                            <label>Contact Number <span class="hint">*</span></label>
                            <input type="text" name="customer_phone"
                                value="{{ old('customer_phone', data_get($prefill, 'customer_phone')) }}" required>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="walkin_time" placeholder="e.g., 3:30 PM"
                                value="{{ old('walkin_time', data_get($prefill, 'walkin_time')) }}" required>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="uom" id="uom-field"
                                value="{{ $uomSel }}" readonly>
                        </div>

                        {{-- Loads --}}
                        <div class="field">
                            <label>Load Quantity <span class="hint">(7 kg = 1 load)</span></label>
                            <input type="number" name="load_qty" min="0" step="1"
                                value="{{ old('load_qty', data_get($prefill, 'load_qty', 0)) }}" required>
                            <label>
                                <input type="checkbox" name="exceeds_8kg" value="1"
                        ...
                        <div class="field" style="grid-column:1 / -1;">
                            ...
                            <textarea name="special_instructions" placeholder="Anything we should know?">{{ old('special_instructions', data_get($prefill, 'special_instructions')) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="actions">
                        <a href="{{ route('admin.dashboard') }}" class="btn btn-back">Cancel</a>
