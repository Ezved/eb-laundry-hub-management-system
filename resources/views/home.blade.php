...
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=DM+Sans:wght@400;500;700&display=swap" rel="stylesheet"></head>
<body>
...
<section class="hero" id="top">
    ...
    <div class="hero-visual">
        <div class="hcard hcard-main">
            <div class="hcard-label">Open Daily</div>
            <div class="hcard-big">8am – 8pm</div>
        </div>
        <div class="hcard hcard-pickup">
            <div class="hcard-label">Next Pickup</div>
            <div class="hcard-mid">Today 3pm</div>
            <div class="hcard-sub">Eden St., Maa</div>
        </div>
        <div class="hcard hcard-loyalty">
            <div class="hcard-label">Loyalty Stamps</div>
            <div class="stamp-dots">
                <span class="sdot filled"></span>
                <span class="sdot filled"></span>
                <span class="sdot filled"></span>
                <span class="sdot filled"></span>
                <span class="sdot filled"></span>
            ...
            <div class="hcard-sub">6 of 10 — 4 more to go!</div>
        </div>
    </div>
</section>
...
(function () {
    ...
    document.querySelectorAll(
        '.why-card, .svc-card, .review-card, .step, .hcard, .sstat'
    ).forEach(el => {
